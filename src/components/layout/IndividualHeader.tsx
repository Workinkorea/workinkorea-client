...
const IndividualHeader = () => {
  ...
  return (
    <header className="w-full bg-white border-b border-line-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="border border-line-200 text-gray-700 px-4 py-2 rounded text-sm hover:bg-gray-50 cursor-pointer">
              개인회원
            </button>
