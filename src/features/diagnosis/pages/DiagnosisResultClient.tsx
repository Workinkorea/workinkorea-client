        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="inline-grid w-28 h-28 sm:w-36 sm:h-36 mb-6">
              ...
              <div className="col-start-1 row-start-1 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-title-2 sm:text-title-1 font-bold text-blue-600">{result.score}%</div>
                  <div className="text-caption-2 text-slate-500 mt-1">{t('readinessLabel')}</div>
                </div>
              </div>
            </div>
            <p className="text-body-3 sm:text-body-1 text-slate-700">
              ...
              <ul className="space-y-2.5">
                {result.strengths.map((strength, index) => (
                  <li key={index} className="flex items-start gap-3">
                    ...
                    <span className="text-caption-1 sm:text-body-3 text-slate-700 leading-relaxed">{strength}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
              ...
              <ul className="space-y-2.5">
                {result.improvements.map((improvement, index) => (
                  <li key={index} className="flex items-start gap-3">
                    ...
                    <span className="text-caption-1 sm:text-body-3 text-slate-700 leading-relaxed">{improvement}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              {result.recommendedJobs.map((job, index) => (
                <motion.div
                  ...
                  className={cn(
                    'px-3 py-2.5 bg-blue-50 border border-blue-100 rounded-lg',
                    'hover:bg-blue-100 transition-colors duration-150'
                  )}
                >
                  <span className="text-caption-1 font-semibold text-blue-700">
                    {job}
                  </span>
                </motion.div>
              ))}
          ...
          <div className="text-center">
            <motion.button
              ...
              className={cn(
                'text-caption-1 sm:text-body-3 text-slate-500 hover:text-slate-700',
