          ...
          <div className="space-y-3">
            {SALARY_RANGES.map((salary) => (
              ...
              >
                ...
                />
                <span className="text-body-3 text-slate-700">{salary.label}</span>
              </label>
            ))}
          </div>
        )}
            ...
            {EMPLOYMENT_TYPES.map((type) => (
              ...
              >
                <input
                  ...
                  className="w-5 h-5 text-blue-600 focus:ring-blue-500"
                />
                <span className="text-body-3 text-slate-700">{type.label}</span>
              </label>
            ))}
          </div>
        )}
            ...
            {COMPANY_SIZES.map((size) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-body-3 text-slate-700">{size.label}</span>
                </div>
              </label>
            ))}
          </div>
            ...
            {START_DATES.map((date) => (
              ...
              >
                <input
                  ...
                  className="w-5 h-5 text-blue-600 focus:ring-blue-500"
                />
                <span className="text-body-3 text-slate-700">{date.label}</span>
              </label>
            ))}
          </div>
        )}
