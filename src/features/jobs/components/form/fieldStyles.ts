 ...
 *
 * border-line-400 = var(--color-line-400) = #E2E8F0 (slate-200)
 * text-label-800  = var(--color-label-800) = #1E293B (slate-800)
 * text-label-400  = var(--color-label-400) = #94A3B8 (slate-400)
...
/** 기본(정상) 상태 보더 */
export const FIELD_DEFAULT = 'border-line-400';        // #E2E8F0

/** 에러 상태 보더 */
export const FIELD_ERROR   = 'border-status-error focus:border-status-error focus:ring-red-100';
