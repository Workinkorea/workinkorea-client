        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-body-3 text-label-500 shrink-0">시간 / 주</span>
            </div>
          </FormField>
        </div>
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className={cn(
                    ...
                    isNegotiableSalary && 'bg-label-100 text-label-400 cursor-not-allowed',
                  )}
                  placeholder="예: 40000000"
                />
              </div>
              <span className="text-body-3 text-label-500 shrink-0">원 / 년</span>
            </div>
