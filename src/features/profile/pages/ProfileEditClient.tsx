        ...
        <div className="relative">
          {imagePreview || profile.profile_image_url ? (
            ...
            <div className="w-20 h-20 rounded-full bg-slate-100 border-4 border-blue-100 flex items-center justify-center">
              <span className="text-title-3 font-semibold text-slate-500">
          ...
          <button
            ...
            className="absolute -bottom-1 -right-1 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-colors cursor-pointer"
          >
            <Camera size={16} />
          </button>
          <input
            ...
            {(portfolioFileName || profile.portfolio_url) && (
              <div className="flex items-center gap-2 flex-1">
                ...
                <button
                  ...
                  className="text-red-500 hover:text-red-600/80 cursor-pointer"
                >
                  <X size={16} />
                </button>
              </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-body-3 text-slate-500">{t('pageSubtitle')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg text-body-3 font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 cursor-pointer"
              >
