...
const services = [
  {
    ...
    desc: (
      <>
        우리 회사 공고를 <span className="text-blue-600 font-semibold">직접 등록</span>할 수 있어요.{' '}
          ...
          <div className="space-y-5">
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <p className="text-caption-2 text-slate-600 leading-relaxed">
                        {svc.desc}
                      </p>
                    </div>
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-caption-1 font-bold text-slate-900">WorkInKorea 채용 현황</p>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {stats.map((stat, i) => (
                  <div key={i} className="text-center">
                    <p className="text-title-5 font-extrabold text-blue-600 mb-0.5">{stat.value}</p>
                    <p className="text-caption-3 text-slate-400">{stat.label}</p>
                  </div>
                ))}
              </div>
            </motion.div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              {[
                ...
                <Link
                  key={item.label}
                  href={item.href}
                  className="flex items-center justify-between px-4 py-3 hover:bg-slate-50 transition-colors border-b border-slate-50 last:border-0 cursor-pointer group"
                >
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-caption-1 font-bold text-slate-800">지금 가입하면</p>
              </div>
            ...
            >
              <p className="text-caption-1 font-bold text-slate-900 mb-3">고객센터</p>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-caption-2 text-slate-700">
                ...
                <div className="flex items-center gap-2 text-caption-3 text-slate-400">
