      ...
      <div className="space-y-4">
        ...
        <div>
          <label htmlFor="industry_type" className="text-caption-1 font-semibold text-slate-700 mb-2 flex items-center">
            업종 <span className="text-red-500 text-title-5 ml-1">*</span>
          </label>
          <Input
            type="text"
            id="industry_type"
        ...
        <div>
          <label htmlFor="company_type" className="text-caption-1 font-semibold text-slate-700 mb-2 flex items-center">
            기업 형태 <span className="text-red-500 text-title-5 ml-1">*</span>
          </label>
          <select
            id="company_type"
            name="company_type"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label htmlFor="employee_count" className="text-caption-1 font-semibold text-slate-700 mb-2 flex items-center gap-2">
              <Users size={16} />
              직원 수 <span className="text-red-500 text-title-5 ml-1">*</span>
            </label>
            <select
              id="employee_count"
              name="employee_count"
          ...
          <div>
            <label htmlFor="establishment_date" className="text-caption-1 font-semibold text-slate-700 mb-2 flex items-center gap-2">
              <Calendar size={16} />
              설립일 <span className="text-red-500 text-title-5 ml-1">*</span>
            </label>
            <Input
              type="date"
        ...
        <div>
          <label htmlFor="insurance" className="text-caption-1 font-semibold text-slate-700 mb-2 flex items-center gap-2">
            <FileText size={16} />
            보험 <span className="text-caption-3 px-2 py-0.5 bg-slate-100 text-slate-600 rounded ml-2">선택</span>
          </label>
          <Input
            type="text"
            id="insurance"
