      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="max-w-4xl w-full">
          <div className="text-center mb-12">
            <h1 className="text-title-1 text-slate-900 mb-4">
              회원가입
            </h1>
            ...
            <Link href="/signup">
              <div className="group bg-white rounded-2xl p-8 border-2 border-slate-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300 cursor-pointer h-full">
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div>
                    <h2 className="text-title-3 text-slate-900 mb-2">개인회원</h2>
            ...
            <Link href="/company-signup/step1">
              <div className="group bg-white rounded-2xl p-8 border-2 border-slate-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300 cursor-pointer h-full">
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div>
                    <h2 className="text-title-3 text-slate-900 mb-2">기업회원</h2>
                    <p className="text-body-3 text-slate-600">
                      채용 담당자 및 기업 회원
                    </p>
                  </div>
