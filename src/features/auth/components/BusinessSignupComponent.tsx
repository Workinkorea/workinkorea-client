          ...
          >
            <label className="flex items-center cursor-pointer group">
              <input
                ...
                className="w-5 h-5 text-blue-600 border-slate-200 rounded focus:ring-2 focus:ring-blue-600 cursor-pointer"
              />
              <span className="ml-3 text-body-3 font-semibold text-slate-900 group-hover:text-blue-600 transition-colors">{t('agreeAll')}</span>
            </label>
          </motion.div>
              ...
              >
                <label className="flex items-start cursor-pointer group gap-3">
                  <input
                    ...
                    className="w-4 h-4 mt-0.5 text-blue-600 border-slate-200 rounded focus:ring-2 focus:ring-blue-600 cursor-pointer shrink-0"
                  />
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-4 sm:px-6 py-8 sm:py-12 lg:p-12 bg-white">
        <div className="max-w-xl mx-auto w-full space-y-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-body-3 text-slate-500">{t('formSubtitle')}</p>
          </motion.div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <motion.button
                        ...
                        className={`inline-flex items-center gap-1.5 px-4 py-2.5 rounded-lg text-body-3 whitespace-nowrap transition-colors ${
                          formState.isVerifying || verifyCooldown > 0 ? 'bg-blue-500 text-white cursor-not-allowed'
