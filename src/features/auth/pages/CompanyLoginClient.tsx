      ...
      <div className="flex flex-1 flex-col justify-center px-8 sm:px-14 lg:px-20 py-12 bg-white">
        <div className="w-full max-w-[400px] mx-auto space-y-6 animate-pulse">
          <div className="space-y-2">
            <div className="h-3 w-16 bg-label-100 rounded" />
            <div className="h-7 w-40 bg-label-100 rounded" />
            <div className="h-3 w-56 bg-label-100 rounded" />
          </div>
          <div className="space-y-2">
            <div className="h-3 w-24 bg-label-100 rounded" />
            <div className="h-11 w-full bg-label-100 rounded-lg" />
          </div>
          <div className="space-y-2">
            <div className="h-3 w-20 bg-label-100 rounded" />
            <div className="h-11 w-full bg-label-100 rounded-lg" />
          </div>
          <div className="h-4 w-24 bg-label-100 rounded" />
          <div className="space-y-3">
            <div className="h-11 w-full bg-primary-100 rounded-lg" />
            <div className="h-11 w-full bg-label-100 rounded-lg" />
          </div>
        </div>
      </div>
