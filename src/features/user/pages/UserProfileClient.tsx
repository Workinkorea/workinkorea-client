      ...
      <Layout>
        <div className="min-h-screen bg-white py-16 sm:py-20 lg:py-24 flex items-center justify-center px-4 sm:px-6">
          <div className="text-center max-w-md mx-auto">
            ...
            <h2 className="text-title-5 sm:text-title-4 font-extrabold text-slate-900 mb-2">
              {t('loadingError')}
            </h2>
            <p className="text-caption-1 sm:text-body-3 text-slate-500 mb-6 sm:mb-8">
              {t('retryHint')}
            </p>
          </div>
        </div>
  ...
  return (
    <Layout>
      ...
      <Modal
        ...
        size="sm"
      >
        <p className="text-body-3 text-slate-700 mb-6">
          &ldquo;{confirmDelete?.title}&rdquo; {t('deleteConfirmText')}
          <br />
          <span className="text-slate-500 text-caption-2 mt-1 block">{t('deleteCannotUndo')}</span>
        </p>
        <div className="flex gap-3 justify-end">
          <button
            onClick={() => setConfirmDelete(null)}
            className="px-4 py-2 border border-slate-200 text-slate-700 rounded-lg text-body-3 font-medium hover:bg-slate-50 transition-colors cursor-pointer"
          >
            {t('cancel')}
          </button>
          <button
              ...
              {[
                ...
                >
                  {activeTab === tab.key && (
                    <motion.div
                      layoutId="tab-bg"
                      className="absolute inset-0 bg-blue-600 rounded-lg shadow-[0_4px_14px_rgba(66,90,213,0.25)]"
                      style={{ zIndex: -1 }}
              ...
              <div className="space-y-5 sm:space-y-6">
                ...
                {resumeList && resumeList.length > 0 ? (
                  ...
                  <div className="text-center py-12 sm:py-16 bg-white rounded-xl border border-slate-200">
                    ...
                    <p className="text-caption-1 sm:text-body-3 text-slate-500 mb-4 sm:mb-6">{t('noResumeEmpty')}</p>
                    <button
