        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="text-body-2 font-semibold text-blue-700 mb-1">
                  주요 강점 영역
                </h4>
              ...
              <div className="text-title-3 font-bold text-blue-600">
                #{1}
              </div>
            </div>
          </div>
            ...
            {(['technical', 'soft', 'language'] as const).map((category) => {
              ...
              return (
                <div key={category} className="p-3 bg-slate-100 rounded-lg">
                  <div className="text-title-4 font-semibold text-slate-700 mb-1">
                    {avgScore}점
                  </div>
                  <div className="text-caption-2 text-slate-500">
                    {getSkillCategoryLabel(category)}
                  </div>
                  <div className="text-caption-2 text-slate-400">
