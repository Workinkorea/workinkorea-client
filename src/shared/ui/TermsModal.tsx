          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-line-200">
                <h2 className="text-title-4 text-label-900 font-semibold">{title}</h2>
                <button
                  onClick={onClose}
                  className="p-2 hover:bg-label-100 rounded-lg transition-colors cursor-pointer"
                  aria-label="닫기"
                >
              ...
              <div className="flex-1 overflow-y-auto p-6">
                <div className="prose prose-sm max-w-none">
                  {content.split('\n').map((line, index) => {
                    ...
                    if (line.startsWith('## ')) {
                      return (
                        <h2 key={index} className="text-title-4 font-bold text-label-900 mt-5 mb-3">
                          {line.replace('## ', '')}
                        </h2>
                      );
                    }
              ...
              <div className="flex items-center justify-end p-6 border-t border-line-200">
                <button
                  onClick={onClose}
                  className="px-6 py-2.5 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors font-medium text-body-3 cursor-pointer"
                >
                  확인
                </button>
              </div>
